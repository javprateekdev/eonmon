...
const Dialogbox = () => {
  ...
  return (
    <div >
      <div  style={{padding:"5px",borderRadius:"10px",fontSize:"16px",fontWeight:"500"}} onClick={handleClickOpen}>Check FloorPlan
      </div>
      ...
      <div>
        <div>
          <div style={{height:"360px",width:"280px",border:"5px solid #161a2d",textAlign:"center"}}>
            <h2 style={{marginTop:"20px"}}>To Check Price Details</h2>
